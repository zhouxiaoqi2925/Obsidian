...
scikit-learn = fit / predict / transform 三件套 + Mixin 能力组合 + 集中输入检查 + Pipeline 链式 + Cython/OpenMP 性能 + BaseEstimator 协议，把"30+ ML 算法"做到 API 完全一致，让 Pipeline / GridSearch / cross_val_score 等元能力对所有算法通用，是 Python ML 生态的事实标准。
