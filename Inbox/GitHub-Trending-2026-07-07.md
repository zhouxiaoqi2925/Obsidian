...
# GitHub Trending 每日 Top 15 (2026-07-07)
...
mindmap
  root((GitHub Trending))
    DietrichGebert/ponyt
    baidu/Unlimited-OCR
    XiaomiMiMo/MiMo-Code
    langchain-ai/openwik
    shadcn/improve
    omnigent-ai/omnigent
    deepseek-ai/DeepSpec
    cobusgreyling/loop-e
    zhongerxin/Cowart
    makerspet/oomwoo
    bikini/exploitarium
    BuilderIO/skills
