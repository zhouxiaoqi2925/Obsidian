...
# HackerNews Best (高赞) Top 15 (2026-06-06)
...
- **分数**: 867 | **评论**: 544 | **作者**: EdwinHoksberg
...
### 7. Meta confirms 1000s of Instagram accounts were hacked by abusing its AI chatbot
...
- **分数**: 437 | **评论**: 154 | **作者**: speckx
- **HN**: https://news.ycombinator.com/item?id=48427643

### 8. GrapheneOS user reported to authorities for using GrapheneOS
...
- **分数**: 437 | **评论**: 447 | **作者**: Cider9986
- **HN**: https://news.ycombinator.com/item?id=48422798

### 9. Tracing a powerful GNSS interference source over Europe
- **链接**: [https://arxiv.org/abs/2606.03673](https://arxiv.org/abs/2606.03673)
- **分数**: 418 | **评论**: 220 | **作者**: mimorigasaka
...
- **分数**: 415 | **评论**: 304 | **作者**: ingve
- **HN**: https://news.ycombinator.com/item?id=48408016

### 12. Pentagon raised threat of Israeli spying on U.S. to highest level, sources say
...
### 14. Gemma 4 QAT models: Optimizing compression for mobile and laptop efficiency
