...
- **语言**: Rust | **Star**: 24229 | **Fork**: 4596
- **更新**: 2026-08-06 | **License**: Apache-2.0
...
- **语言**: JavaScript | **Star**: 13265 | **Fork**: 1305
- **更新**: 2026-08-06 | **License**: 未知
...
- **语言**: Python | **Star**: 13134 | **Fork**: 1772
- **更新**: 2026-08-06 | **License**: MIT
...
- **语言**: TypeScript | **Star**: 11718 | **Fork**: 1297
- **更新**: 2026-08-06 | **License**: MIT
...
- **语言**: TypeScript | **Star**: 8718 | **Fork**: 610
- **更新**: 2026-08-06 | **License**: Apache-2.0
- **主题**: ai-security、application-security、cli、code-scanning、codex、codex-security、cybersecurity、devsecops

#### 前面介绍

- OpenAI Codex Security 是一个基于 AI 的安全扫描工具，旨在帮助开发者发现、验证和修复代码中的安全漏洞。它提供命令行界面（CLI）和 TypeScript SDK，利用 Codex 模型对代码进行深度分析。该工具支持多种推理提供商（如 OpenRouter、Fireworks、AWS Bedrock），并提供了容器化支持以便于 CI/CD 集成和批量扫描。
...
- 多模型推理支持
- 支持 OpenRouter、Fireworks 和 AWS Bedrock
- 灵活的凭证管理
- 支持 ChatGPT 登录和 API 密钥
- CI 环境优先使用 API 密钥
- 深度扫描模式
...
- **语言**: Rust
- **Star**: 24229 | **Fork**: 4596 | **更新**: 2026-08-06

### 2. Fei-Away/Codex-Dream-Skin
- **仓库**: [Fei-Away/Codex-Dream-Skin](https://github.com/Fei-Away/Codex-Dream-Skin)
- **描述**: Codex Dream Skin
- **语言**: JavaScript
- **Star**: 13265 | **Fork**: 1305 | **更新**: 2026-08-06

### 3. andrewyng/openworker
- **仓库**: [andrewyng/openworker](https://github.com/andrewyng/openworker)
- **语言**: Python
- **Star**: 13134 | **Fork**: 1772 | **更新**: 2026-08-06

### 4. yc-software/qm
- **仓库**: [yc-software/qm](https://github.com/yc-software/qm)
- **描述**: Multiplayer agent harness for work
- **语言**: TypeScript
- **Star**: 11718 | **Fork**: 1297 | **更新**: 2026-08-06
...
- **语言**: Python
- **Star**: 9907 | **Fork**: 737 | **更新**: 2026-08-06
...
- **语言**: TypeScript
- **Star**: 8718 | **Fork**: 610 | **更新**: 2026-08-06
...
- **语言**: Rust
- **Star**: 5205 | **Fork**: 225 | **更新**: 2026-08-06
...
- **语言**: Swift
- **Star**: 5124 | **Fork**: 265 | **更新**: 2026-08-06
